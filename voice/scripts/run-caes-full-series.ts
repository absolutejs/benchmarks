...
console.log(
  [
    ...
    resolve(
      projectRoot,
      "benchmark-results",
      "stt-deepgram-code-switch-ca-es-series-5.json",
    ),
    resolve(
      projectRoot,
      "benchmark-results",
      "stt-deepgram-corrected-code-switch-ca-es-series-5.json",
    ),
    resolve(
      projectRoot,
      "benchmark-results",
      "stt-deepgram-code-switch-ca-es-corts-series-5.json",
    ),
    resolve(
      projectRoot,
      "benchmark-results",
      "stt-deepgram-corrected-code-switch-ca-es-corts-series-5.json",
    ),
    resolve(
      projectRoot,
      "benchmark-results",
